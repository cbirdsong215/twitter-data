...
#2
twitter_data.each do |username|
  username.each do |username, followers|
    puts "#{username}: #{followers["number of followers"]}"
  end
end

#3
twitter_data.each do |username|
  username.each do |username, tweet_length|
    puts "#{username}'s latest tweet was #{tweet_length["latest tweet"].size} characters long"
  end
end
...
twitter_data.each do |username|
  username.each do |username, tweet_length|
    puts "#{username} used #{tweet_length["last twenty tweets"].join.length} characters in their last twenty tweets"
  end
end
...
total_followers = {}
twitter_data.each do |usernames|
  usernames.each do |username, followers|
    total_followers[username] = followers["number of followers"]
 end
end

total_followers.each do |name, followers|
if total_followers[name] == total_followers.values.max
...
total_friends = {}
twitter_data.each do |usernames|
  usernames.each do |username, friends|
    total_friends[username] = friends["number of friends"]
 end
end
total_friends.each do |name, friends|
if total_friends[name] == total_friends.values.max
puts "#{name} has the most friends"
 end
end
...
total_tweets = {}
twitter_data.each do |usernames|
  usernames.each do |username, tweets|
    total_tweets[username] = tweets["number of tweets"]
 end
end

total_tweets.each do |name, tweets|
if total_tweets[name] == total_tweets.values.max
puts "#{name} has the most tweets"
 end
end
...
total_description = {}
twitter_data.each do |usernames|
  usernames.each do |username, description|
    total_description[username] = description["description"]
 end
end

total_description.each do |name, description|
if total_description[name] != nil
puts "#{name}"
  end
end
...
total_location = {}
twitter_data.each do |usernames|
  usernames.each do |username, location|
    total_location[username] = location["location"]
 end
end

total_location.each do |name, location|
if total_location[name] != nil
puts "#{name}"
  end
end
